...
import com.appspot.piment.api.sina.OAuthApi;
...
public class SinaAuthServiceImpl extends RemoteServiceServlet implements SinaAuthService {

  private static final long serialVersionUID = 119036653845249125L;
  ...
  public String requestToken() throws IllegalArgumentException {
	...
	try {
	  ...
	  log.info("-- processing requestToken  --");
	  ...
	  return configItemDao.getValue("sina.authorize.url") + "?oauth_token=" + authToken.getToken();
